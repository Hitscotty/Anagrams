...
public class AnagramsActivity extends AppCompatActivity {
    ...
    public static String START_MESSAGE = "Find as many words as possible that can be formed with: <big>%s</big> ";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_easy) {
            ...
            START_MESSAGE = "Find as many words as possible that can be formed with: <big>%s</big> ";
            return true;
        }

        if (id == R.id.menu_medium) {
            dictionary.setMode(1);
            START_MESSAGE = "Find as many words as possible that can be formed by adding one letter to <big>%s</big> (but that do not contain the substring %s).";
            return true;
        }

        if (id == R.id.menu_hard) {
